...
const Icon = ({ name, className = "w-5 h-5" }) => {
  const icons = {
    ...
    sparkles: <><path d="m12 3 1.912 4.912L18.824 9.824 13.912 11.736 12 16.648l-1.912-4.912L5.176 9.824l4.912-1.912L12 3z"/><path d="m5 3 1 2.5L8.5 7l-2.5 1-1 2.5L4 8 1.5 7l2.5-1L5 3z"/><path d="m19 17 1 2.5 2.5 1.5-2.5 1-1 2.5-1-2.5L15.5 21l2.5-1 1-2.5z"/></>,
    party: <><path d="M18 2h3"/><path d="M15 5.5V9"/><path d="M19 9h3"/><path d="M5 22h14"/><path d="m5 22 7-15 7 15"/></>,
